...
import {BASE_RECIPE_URL, BASE_INGREDIENT_URL , POST_INGREDIENT_URL, POST_RECIPE_URL } from './components/constants'
  ...
  handleSubmit = e => {
    ...
    axios.post(`${BASE_RECIPE_URL}${POST_RECIPE_URL}`, { recipeTitle: this.state.recipeName, recipeMethod: this.state.recipeMethod,  cookTime: this.state.cookTime, prepTime: this.state.prepTime, pricePerUnit: this.state.pricePerUnit })
     .then((res) => {
         console.log(res);
     })
     .catch(err => {
    ...
    axios.post(`${BASE_INGREDIENT_URL}${ POST_INGREDIENT_URL}`,  {ingredientName: this.state.ingredient, ingredientAmount: this.state.ingredientAmount })
     .then((res) => {
         console.log(res);
     })
     .catch(err => {
      ...
      <Form onSubmit={this.handleSubmit} noValidate>
        ...
        <Row>
          ...
          <Col>
            ...
            <Form.Control type="text" placeholder="Ingredient Amount" 
